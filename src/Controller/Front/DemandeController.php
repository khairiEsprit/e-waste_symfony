...
// Créer une nouvelle demande
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, UserRepository $userRepository, CentreRepository $centreRepository): Response
    {
        $demande = new Demande();

        // Fetch the user and centre with id = 1
        $user = $userRepository->find(1);
        $centre = $centreRepository->find(1);
...
// Si le formulaire est soumis et valide, enregistrer la demande
        if ($form->isSubmitted() && $form->isValid()) {
            // Set the user and centre for the demande
