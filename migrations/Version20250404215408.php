 ...
 */
final class Version20250404215408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plannificationtache (id INT AUTO_INCREMENT NOT NULL, id_tache_id INT NOT NULL, priorite VARCHAR(255) NOT NULL, date_limite DATE NOT NULL, INDEX IDX_AD0273F782F8B1AC (id_tache_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
