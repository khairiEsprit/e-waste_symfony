 ...
 */
final class Version20250414131430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation ADD event_id INT NOT NULL, ADD reminder_sent TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation DROP event_id, DROP reminder_sent');
    }
}
