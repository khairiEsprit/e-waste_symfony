 ...
 */
final class Version20250403102307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE poubelle (id INT AUTO_INCREMENT NOT NULL, centre_id INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, niveau INT DEFAULT NULL, etat VARCHAR(255) NOT NULL, date_installation DATE NOT NULL, hauteur_totale INT NOT NULL, INDEX IDX_B5344EA3463CD7C3 (centre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE centre CHANGE telephone telephone VARCHAR(20) NOT NULL');
    }
